...
mod tests {
    ...
    fn test_rotate_adds_new_subkeys() {
        ...
        let (rotated, actions) =
            rotate_subkeys(&key, KeyType::Ed25519, "2y", "testpassphrase", false).unwrap();
    ...
    fn test_rotate_with_revoke_old() {
        ...
        let (rotated, actions) =
            rotate_subkeys(&key, KeyType::Ed25519, "2y", "testpassphrase", true).unwrap();
    ...
    fn test_rotate_invalid_expiration() {
        ...
        let result = rotate_subkeys(&key, KeyType::Ed25519, "2w", "testpassphrase", false);
