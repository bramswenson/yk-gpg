...
pub struct ProvisionPlan {
    ...
    /// Hex-encoded primary key fingerprint.
...
mod tests {
    ...
    fn generate_test_key() -> (SignedSecretKey, String) {
        ...
        let key = keygen::generate_key(
            "Provision Test <provision@example.com>",
            KeyType::Ed25519,
            "2y",
            "testpassphrase",
            rng,
    ...
    fn setup_test_env(data_dir: &Path) -> (SignedSecretKey, String) {
